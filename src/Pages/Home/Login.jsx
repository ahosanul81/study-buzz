    ...
    const handleLogin = (e)=>{
        ...
        loginUser(email, password)
            ...
            .catch((error) => {
                ...
                setError('Please input valid email and password' + '  ' + error.message)
            });
    }
    return (
        <div className='container mx-auto flex justify-center '>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800 border border-amber-300">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <button type='submit' className="block w-full p-3 text-center rounded-sm text-gray-50 bg-teal-600">Login</button>
                </form>
