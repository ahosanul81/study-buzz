...
const Navbar = () => {
    ...
    const navLinks = <>
        <li><NavLink to='/assignments' className={({ isActive, isPending }) =>
            isPending ? "pending " : isActive ? "btn-outline border border-orange-400 " : "text-black lg:text-gray-200"
        }>Assignments</NavLink></li>
        <li><NavLink to='/create_assignments' className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "btn-outline border border-orange-400" : "text-black lg:text-gray-200"
        }>Create assignments</NavLink></li>
        <li><NavLink to='/pending_assignments' className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "btn-outline border border-orange-400" : "text-black lg:text-gray-200"
        }>Pending assignments</NavLink></li>
    </>
    ...
    return (
        <div className='h-16 mx-auto'>
            <div className=" container mx-auto mb-6 navbar min-w-full bg-[#7e6f28] fixed z-50">
                <div className="navbar-start ">
                    ...
                    <Link to="/" className=''>
                        <div className='w-20 h-10 lg:w-24 lg:h-12 ml-4 rounded-full flex flex-row justify-center items-center'>

                            <img className='w-full h-full ' src="https://i.ibb.co/3d2Br7z/study-buzz-logo-for-fav-Icon.png" alt="aaa" />

                            <h1 className='flex flex-row gap-1'><span className='font-bold text-gray-300'>Study</span> <span className='text-amber-600 font-bold'>Buzz</span></h1>
